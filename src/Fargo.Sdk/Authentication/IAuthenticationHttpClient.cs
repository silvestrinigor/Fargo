...
public interface IAuthenticationHttpClient
{
    ...
    Task<FargoSdkResponse<AuthInfo>> LogInAsync(string nameid, string password, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    Task<FargoSdkResponse<AuthInfo>> Refresh(string refreshToken, CancellationToken cancellationToken = default);
