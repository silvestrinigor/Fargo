...
namespace Fargo.Infrastructure.Migrations
{
    ...
    [Migration("20260914130815_ItemParentContainerHistory2")]
    partial class ItemParentContainerHistory2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fargo.Core.Audits.AuditLog", b =>
                {
                    ...
                    b.HasIndex("ActorGuid", "OccurredAt")
                        .HasDatabaseName("ix_audit_logs_actor_guid_occurred_at");

                    b.HasIndex("EntityGuid", "OccurredAt")
                        .HasDatabaseName("ix_audit_logs_entity_guid_occurred_at");
            ...
            modelBuilder.Entity("Fargo.Core.Identity.AuthenticationAttempt", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Guid")
                        .HasName("pk_authentication_attempt");

                    b.HasIndex("IpAddress", "ActorIdentifier", "OccuredAt", "Successful")
                        .HasDatabaseName("ix_authentication_attempt_ip_address_actor_identifier_occured_");

                    b.ToTable("authentication_attempt", (string)null);
                });
            ...
            modelBuilder.Entity("Fargo.Infrastructure.Entities.ItemParentContainerHistoryPostgresTemporal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<NpgsqlRange<DateTimeOffset>>("ValidPeriod")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("Id")
                        .HasName("pk_item_parent_container_history");

                    b.HasIndex("ItemGuid")
                        .HasDatabaseName("ix_item_parent_container_history_item_guid");

                    b.HasIndex("ParentItemContainerGuid")
                        .HasDatabaseName("ix_item_parent_container_history_parent_item_container_guid");

                    b.ToTable("item_parent_container_history", (string)null);
                });
            ...
            modelBuilder.Entity("Fargo.Infrastructure.Entities.ItemParentContainerHistoryPostgresTemporal", b =>
                {
                    b.HasOne("Fargo.Core.Items.Item", "Item")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_item_parent_container_history_items_item_guid");

                    b.HasOne("Fargo.Core.Items.Item", "ParentItemContainer")
                        .WithMany()
                        .HasForeignKey("ParentItemContainerGuid")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_item_parent_container_history_items_parent_item_container_g");
