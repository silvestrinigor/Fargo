...
namespace Fargo.Infrastructure.Migrations
{
    ...
    [Migration("20260811133805_ItemParentContainerHistory")]
    partial class ItemParentContainerHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fargo.Core.Items.ItemParentContainerHistory", b =>
                {
                    ...
                    b.Property<Guid?>("ItemGuid1")
                        .HasColumnType("uuid")
                        .HasColumnName("item_guid1");
                    ...
                    b.HasAlternateKey("ItemGuid", "ValidAt")
                        .HasName("ak_item_moviments_item_guid_valid_at");

                    b.HasIndex("ItemGuid1")
                        .HasDatabaseName("ix_item_moviments_item_guid1");

                    b.HasIndex("ParentItemContianerGuid")
                        .HasDatabaseName("ix_item_moviments_parent_item_contianer_guid");
            ...
            modelBuilder.Entity("Fargo.Core.Items.ItemParentContainerHistory", b =>
                {
                    ...
                    b.HasOne("Fargo.Core.Items.Item", null)
                        ...
                        .HasForeignKey("ItemGuid1")
                        .HasConstraintName("fk_item_moviments_items_item_guid1");

                    b.HasOne("Fargo.Core.Items.Item", "ParentItemContainer")
                        .WithMany()
                        .HasForeignKey("ParentItemContianerGuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_item_moviments_items_parent_item_contianer_guid");
