...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fargo.Core.Workspaces.Workspace", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Fargo.Core.Workspaces.WorkspaceCommand", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("WorkspaceGuid", "Sequence")
                        .IsUnique();

                    b.ToTable("WorkspaceCommands", (string)null);
                });
            ...
            modelBuilder.Entity("Fargo.Core.Workspaces.WorkspaceCommand", b =>
                {
                    b.HasOne("Fargo.Core.Workspaces.Workspace", "Workspace")
                        .WithMany("Commands")
                        .HasForeignKey("WorkspaceGuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
