...
namespace Fargo.Http.Client.Models
{
    ...
    public partial class ArticlePackDto : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The unique identifier of the article from which the pack is composed.</summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Fargo.Http.Client.Models.ArticlePackDto"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Fargo.Http.Client.Models.ArticlePackDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Fargo.Http.Client.Models.ArticlePackDto();
        }
        /// <summary>
