...
namespace Fargo.Http.Client.Models
{
    ...
    public partial class ItemContainerInventoryDto : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// </summary>
        public ItemContainerInventoryDto()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Fargo.Http.Client.Models.ItemContainerInventoryDto"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Fargo.Http.Client.Models.ItemContainerInventoryDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Fargo.Http.Client.Models.ItemContainerInventoryDto();
        }
        /// <summary>
