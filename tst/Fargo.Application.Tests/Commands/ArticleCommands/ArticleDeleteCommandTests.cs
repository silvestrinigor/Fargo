...
public sealed class ArticleDeleteCommandHandlerTests
{
    ...
    private readonly ArticleDeleteCommandHandler handler;

    public ArticleDeleteCommandHandlerTests()
    {
        articleService = new ArticleService(articleRepository);

        handler = new ArticleDeleteCommandHandler(
            articleRepository,
            userRepository,
            articleService,
            unitOfWork,
    ...
    public async Task Handle_Should_ThrowUnauthorizedAccessFargoApplicationException_When_ActorIsNotFound()
    {
        ...
        articleRepository.DidNotReceive()
            .Remove(Arg.Any<Article>());
    ...
    public async Task Handle_Should_ThrowUserInactiveFargoDomainException_When_ActorIsInactive()
    {
        ...
        await articleRepository.DidNotReceive()
            .HasItemsAssociated(Arg.Any<Guid>(), Arg.Any<CancellationToken>());
    ...
    private static ArticleDeleteCommand CreateCommand()
        => new(Guid.NewGuid());
