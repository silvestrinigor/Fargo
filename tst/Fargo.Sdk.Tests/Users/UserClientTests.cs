...
public sealed class UserClientTests
{
    ...
    public async Task GetAsync_Should_ReturnSuccess_When_HttpResponseIsSuccess()
    {
        ...
        httpClient
            .GetAsync<Fargo.Api.Contracts.Users.UserDto>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<Fargo.Api.Contracts.Users.UserDto>(true, userResult, null, HttpStatusCode.OK));
    ...
    public async Task GetAsync_Should_ReturnNotFound_When_ProblemTypeIsUserNotFound()
    {
        httpClient
            .GetAsync<Fargo.Api.Contracts.Users.UserDto>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<Fargo.Api.Contracts.Users.UserDto>(false, null, Fakes.Problem("user/not-found"), HttpStatusCode.NotFound));
    ...
    public async Task GetAsync_Should_ReturnUnauthorizedAccess_When_ProblemTypeIsUnauthorized()
    {
        httpClient
            .GetAsync<Fargo.Api.Contracts.Users.UserDto>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<Fargo.Api.Contracts.Users.UserDto>(false, null, Fakes.Problem("auth/unauthorized"), HttpStatusCode.Unauthorized));
    ...
    public async Task GetAsync_Should_ReturnForbidden_When_ProblemTypeIsUserForbidden()
    {
        httpClient
            .GetAsync<Fargo.Api.Contracts.Users.UserDto>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<Fargo.Api.Contracts.Users.UserDto>(false, null, Fakes.Problem("user/forbidden"), HttpStatusCode.Forbidden));
    ...
    public async Task GetAsync_Should_ReturnUndefined_When_ProblemTypeIsUnknown()
    {
        httpClient
            .GetAsync<Fargo.Api.Contracts.Users.UserDto>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<Fargo.Api.Contracts.Users.UserDto>(false, null, Fakes.Problem("server/internal-error"), HttpStatusCode.InternalServerError));
    ...
    public async Task GetAsync_Should_ReturnFallbackDetail_When_ProblemDetailsIsNull()
    {
        httpClient
            .GetAsync<Fargo.Api.Contracts.Users.UserDto>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<Fargo.Api.Contracts.Users.UserDto>(false, null, null, HttpStatusCode.InternalServerError));
    ...
    {
        IReadOnlyCollection<Fargo.Api.Contracts.Users.UserDto> users = [Fakes.UserResult(), Fakes.UserResult()];
        httpClient
            .GetAsync<IReadOnlyCollection<Fargo.Api.Contracts.Users.UserDto>>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<IReadOnlyCollection<Fargo.Api.Contracts.Users.UserDto>>(true, users, null, HttpStatusCode.OK));
    ...
    public async Task GetManyAsync_Should_ReturnEmptyCollection_When_DataIsNull()
    {
        httpClient
            .GetAsync<IReadOnlyCollection<Fargo.Api.Contracts.Users.UserDto>>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<IReadOnlyCollection<Fargo.Api.Contracts.Users.UserDto>>(true, null, null, HttpStatusCode.NoContent));
    ...
    public async Task GetManyAsync_Should_ReturnForbidden_When_ProblemTypeIsPartitionAccessDenied()
    {
        httpClient
            .GetAsync<IReadOnlyCollection<Fargo.Api.Contracts.Users.UserDto>>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<IReadOnlyCollection<Fargo.Api.Contracts.Users.UserDto>>(false, null, Fakes.Problem("partition/access-denied"), HttpStatusCode.Forbidden));
    ...
    public async Task CreateAsync_Should_ReturnGuid_When_HttpResponseIsSuccess()
    {
        ...
        httpClient
            .PostFromJsonAsync<Fargo.Api.Contracts.Users.UserCreateDto, Guid>(Arg.Any<string>(), Arg.Any<Fargo.Api.Contracts.Users.UserCreateDto>(), Arg.Any<CancellationToken>())
    ...
    {
        httpClient
            .PatchJsonAsync<Fargo.Api.Contracts.Users.UserUpdateDto>(Arg.Any<string>(), Arg.Any<Fargo.Api.Contracts.Users.UserUpdateDto>(), Arg.Any<CancellationToken>())
    ...
    {
        public static Fargo.Api.Contracts.Users.UserDto UserResult() =>
