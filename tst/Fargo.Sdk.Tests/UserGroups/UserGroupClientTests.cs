...
public sealed class UserGroupClientTests
{
    ...
    {
        httpClient
            .PatchJsonAsync<Fargo.Sdk.Contracts.UserGroups.UserGroupUpdateRequest>(Arg.Any<string>(), Arg.Any<Fargo.Sdk.Contracts.UserGroups.UserGroupUpdateRequest>(), Arg.Any<CancellationToken>())
