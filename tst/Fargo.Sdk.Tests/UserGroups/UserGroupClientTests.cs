...
public sealed class UserGroupClientTests
{
    ...
    public async Task GetAsync_Should_ReturnSuccess_When_HttpResponseIsSuccess()
    {
        ...
        httpClient
            .GetAsync<UserGroupResult>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<UserGroupResult>(true, userGroupResult, null, HttpStatusCode.OK));
    ...
    public async Task GetAsync_Should_ReturnNotFound_When_ProblemTypeIsUserGroupNotFound()
    {
        httpClient
            .GetAsync<UserGroupResult>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<UserGroupResult>(false, null, Fakes.Problem("user-group/not-found"), HttpStatusCode.NotFound));
    ...
    public async Task GetAsync_Should_ReturnUnauthorizedAccess_When_ProblemTypeIsUnauthorized()
    {
        httpClient
            .GetAsync<UserGroupResult>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<UserGroupResult>(false, null, Fakes.Problem("auth/unauthorized"), HttpStatusCode.Unauthorized));
    ...
    public async Task GetAsync_Should_ReturnForbidden_When_ProblemTypeIsUserForbidden()
    {
        httpClient
            .GetAsync<UserGroupResult>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<UserGroupResult>(false, null, Fakes.Problem("user/forbidden"), HttpStatusCode.Forbidden));
    ...
    public async Task GetAsync_Should_ReturnFallbackDetail_When_ProblemDetailsIsNull()
    {
        httpClient
            .GetAsync<UserGroupResult>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<UserGroupResult>(false, null, null, HttpStatusCode.InternalServerError));
    ...
    {
        IReadOnlyCollection<UserGroupResult> groups = [Fakes.UserGroupResult(), Fakes.UserGroupResult()];
        httpClient
            .GetAsync<IReadOnlyCollection<UserGroupResult>>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<IReadOnlyCollection<UserGroupResult>>(true, groups, null, HttpStatusCode.OK));
    ...
    public async Task GetManyAsync_Should_ReturnEmptyCollection_When_DataIsNull()
    {
        httpClient
            .GetAsync<IReadOnlyCollection<UserGroupResult>>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<IReadOnlyCollection<UserGroupResult>>(true, null, null, HttpStatusCode.NoContent));
    ...
    public async Task GetManyAsync_Should_ReturnForbidden_When_AccessDenied()
    {
        httpClient
            .GetAsync<IReadOnlyCollection<UserGroupResult>>(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FargoSdkHttpResponse<IReadOnlyCollection<UserGroupResult>>(false, null, Fakes.Problem("entity/access-denied"), HttpStatusCode.Forbidden));
