...
public sealed class ApiClientClientTests
{
    ...
    public async Task CreateAsync_Should_ReturnCreatedResult_When_HttpResponseIsSuccess()
    {
        ...
        httpClient
            .PostFromJsonAsync<Fargo.Sdk.Contracts.ApiClients.ApiClientCreateDto, ApiClientCreatedDto>(Arg.Any<string>(), Arg.Any<Fargo.Sdk.Contracts.ApiClients.ApiClientCreateDto>(), Arg.Any<CancellationToken>())
    ...
    {
        httpClient
            .PatchJsonAsync<Fargo.Sdk.Contracts.ApiClients.ApiClientUpdateDto>(Arg.Any<string>(), Arg.Any<Fargo.Sdk.Contracts.ApiClients.ApiClientUpdateDto>(), Arg.Any<CancellationToken>())
